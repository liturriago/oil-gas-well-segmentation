...
class ResUNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=1, backbone_name="resnet34", pretrained=True):
        ...
        self.enc1 = nn.Sequential(self.encoder.conv1, self.encoder.bn1, self.encoder.relu) # -> skip1 (64 channels)
        self.enc2 = nn.Sequential(self.encoder.maxpool, self.encoder.layer1) # -> skip2 (64 channels)
